...
const INTERACTIVE_LINES: DemoLine[] = [
  ...
  { kind: "headlineBlue", text: "   🏰 ⚒️ Preparing apply" },
  ...
  { kind: "default", text: "     ✓ ⛴️ Docker container started" },
  { kind: "headlineBlue", text: "   🏰 ✅ Infrastructure deployed - 1m 2s" },
  { kind: "default", text: "      👉🏻 Server       ec2-user@<>" },
  { kind: "default", text: "      👉🏻 eRPC         http://erpc:4000" },
  { kind: "default", text: "      👉🏻 Logs         evm-cloud logs" },
...
const CI_LINES: DemoLine[] = [
  ...
  { kind: "default", text: "     ✓ VPC + networking" },
  { kind: "default", text: "     ✓ ⛴️ Docker container started" },
  { kind: "headlineBlue", text: "   🏰 ✅ Infrastructure deployed - 58s" },
  { kind: "default", text: "      👉🏻 Server       ec2-user@<>" },
  { kind: "default", text: "      👉🏻 eRPC         http://erpc:4000" },
  { kind: "default", text: "      👉🏻 Logs         evm-cloud logs" },
  { kind: "default", text: "      👉🏻 Status       evm-cloud status" },
