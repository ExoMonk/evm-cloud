...
const FORK_LINES: DemoLine[] = [
  ...
  { kind: "spinner", text: "     🔄 Clustering...." },
  { kind: "default", text: "     ✓ kind cluster ready" },
  { kind: "default", text: "     ✓ Anvil healthy (fork mode)" },
  { kind: "default", text: "     ✓ eRPC healthy" },
  { kind: "default", text: "     ✓ ClickHouse healthy" },
  { kind: "default", text: "     ✓ rindexer healthy" },
  { kind: "headlineBlue", text: "   🏰 ✅ Local stack ready - 2m 03s" },
  { kind: "blank", text: "" },
  { kind: "cmd", text: "evm-cloud local status" },
  ...
  { kind: "blank", text: "" },
  { kind: "cmd", text: "evm-cloud local down" },
  { kind: "warn", text: "     🚧 stopping local services" },
  { kind: "headlineRed", text: "   🏰 🚀 Local stack stopped - 18s" },
];
...
const FRESH_LINES: DemoLine[] = [
  ...
  { kind: "spinner", text: "     🔄 Clustering...." },
  { kind: "default", text: "     ✓ kind cluster ready" },
  { kind: "default", text: "     ✓ Anvil healthy (chain_id=31337)" },
  { kind: "default", text: "     ✓ eRPC healthy" },
  { kind: "default", text: "     ✓ ClickHouse healthy" },
  { kind: "default", text: "     ✓ rindexer healthy" },
