...
# Check logs
evm-cloud kubectl logs -n evm-cloud -l app.kubernetes.io/name=indexer --tail=50
evm-cloud kubectl logs -n evm-cloud -l app.kubernetes.io/name=rpc-proxy --tail=50
```
