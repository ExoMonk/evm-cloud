...
| Any VPS, no AWS | [`bare_metal_byo_clickhouse`](./examples/bare-metal-clickhouse.mdx) |
| Infra only (deploy workloads yourself) | [`minimal_aws_external_ec2_byo`](./examples/external-ec2.mdx) or [`external_eks`](./examples/external-eks.mdx) |
