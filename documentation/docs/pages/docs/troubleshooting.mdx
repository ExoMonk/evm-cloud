...
```bash
evm-cloud deploy --teardown   # or: terraform output -json workload_handoff | ./deployers/k3s/teardown.sh /dev/stdin
evm-cloud destroy --yes       # or: terraform destroy -var-file=your.tfvars
```
